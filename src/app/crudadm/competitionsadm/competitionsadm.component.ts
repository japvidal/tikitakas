...
@Component({
  selector: 'app-competitionsadm',
  templateUrl: './competitionsadm.component.html',
  styleUrls: ['./competitionsadm.component.css'],
  providers: [DatePipe]
})
export class CompetitionsadmComponent implements OnInit {
  ...
  guardar():void{
    ...
    if (this.competition.id === 0){
      this.apiServices.addCompetition(this.competition).subscribe(
        response => {
          this.reset();
          this.forma.reset();
      ...
      this.apiServices.editCompetition(this.competition).subscribe(
        response => {
          this.reset();
          this.forma.reset();
    ...
    cargarCompeticiones(){
      ...
      this.apiServices.getCompetitions( )
